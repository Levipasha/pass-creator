...
interface PassAPIPreviewProps {
  details: PassDetails;
  onDownload: () => void;
  onEdit: () => void;
}

export const PassAPIPreview: React.FC<PassAPIPreviewProps> = ({
  details,
  onDownload,
  onEdit,
}) => {
  ...
  return (
    <div className="api-view-mode">
      <div className="pass-container-outer">
        <PassPreview details={details} isPreview={false} />
      </div>
